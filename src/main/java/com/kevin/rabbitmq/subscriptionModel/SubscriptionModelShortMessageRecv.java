 ...
 * 订阅模式-短信消费者
 */
public class SubscriptionModelShortMessageRecv {
    /**
     * 短信队列
     */
    private static final String QUEUE_NAME = "subscription_model_shortMessage_queue";
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        Consumer consumer = new DefaultConsumer(channel) {
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                ...
                System.out.println(" [shortMessage] Received '" + message + "'");
                try {
                    Thread.sleep(1000);
                } catch (InterruptedException e) {
                    e.printStackTrace();
                } finally {
                    System.out.println(" [shortMessage] done ");
